...
namespace CarRenewalStatisticsService
{
    class Configuration
    {
        private const string PrefixServerConfiguration = "CRM_CarRenewalStatisticsService.server";
        ...
        private const string DefaultServiceName = "CRM_CarRenewalStatisticsService";
        private const string DefaultServiceDisplayName = "CRM_CarRenewalStatisticsService";
        private const string DefaultServiceDescription = "统计服务";
