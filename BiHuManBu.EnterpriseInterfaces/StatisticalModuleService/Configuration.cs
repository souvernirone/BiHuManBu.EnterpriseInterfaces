...
namespace StatisticalModuleService
{
	...
	{
        private const string PrefixServerConfiguration = "StatisticalModuleService.server";
        ...
        private const string DefaultServiceName = "StatisticalModuleService";
        private const string DefaultServiceDisplayName = "StatisticalModuleService";
		private const string DefaultServiceDescription = "创建统计模块服务";
