...
namespace ConsoleApplication1
{
    public class DbCommon
    {
        ...
        public DataTable GetBatchRefreshRenewal()
        {
            ...
            logInfo.Info(sqlBuilder.ToString());
            return MySqlHelper.ExecuteDataTable(conn, sqlBuilder.ToString());
        ...
        public bool UpdateBatchRefreshRenewalStatus(DataRow row, int refrenewalstatus)
        {
            ...
            return result = MySqlHelper.ExecuteNonQuery(conn, sql) > 0;
            //}
            //catch (Exception ex)
            //{
        ...
        public bool UpdateRefRenewalStatusById(string ids, int refrenewalstatus)
        {
            ...
            return MySqlHelper.ExecuteNonQuery(conn, sql) > 0;
            //}
            //catch (Exception ex)
            //{
