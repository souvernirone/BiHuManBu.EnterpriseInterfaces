...
namespace ConsumerReviewRemind
{
        ...
        {
            private const string PrefixServerConfiguration = "ConsumerReviewRemindJobTest.server";
            ...
            private const string DefaultServiceName = "ConsumerReviewRemindJobTest";
            private const string DefaultServiceDisplayName = "ConsumerReviewRemindJobTest_Server";
            private const string DefaultServiceDescription = "检查30分钟内回访信息提醒";
