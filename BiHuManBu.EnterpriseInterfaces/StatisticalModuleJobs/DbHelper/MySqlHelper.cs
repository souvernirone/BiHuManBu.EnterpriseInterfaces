...
namespace StatisticalModuleJobs.DbHelper
{
    /// <summary>
    /// MySqlHelper操作类
    /// </summary>
    public sealed partial class MySqlHelper
    {
        ...
        public static int ExecuteNonQuery(string connectionString, string commandText, params MySqlParameter[] parms)
        {
            ...
            try
            {
                count = ExecuteNonQuery(connection, CommandType.Text, commandText, parms);
            }
            catch (Exception ex)
            {
                //CommonLoggingInfo.WriteError("操作失败:" + ex.Message);
            }
            finally
            {
                connection.Dispose();
        ...
        public static int ExecuteNonQuery(string connectionString, CommandType commandType, string commandText, params MySqlParameter[] parms)
        {
            ...
            try
            {
                ...
                count = ExecuteNonQuery(connection, commandType, commandText, parms);
                return count;
            }
            catch (Exception ex)
            {
        ...
        //public static object UpdateAgentAndOpneIdByList<T>(List<T> list, string connectionString, string tableName, List<long> ids) where T:class
        //{
        //    int count = 0;
        //    if (list == null || list.Count <= 0) throw new Exception("List无任何数据");
        //    if (string.IsNullOrEmpty(tableName)) throw new Exception("添加失败！请先设置插入的表名");
        //    var sql = PrepareSql<T>(list, "BuId", tableName);
        //    #region 注释代码
        //    //StringBuilder sb = new StringBuilder();
        ...
        //    //{
        //    //    sb.Append(" when " + item.GetType().GetProperty("BuId").GetValue(item, null) + "" + " Then '" + item.GetType().GetProperty("Agent").GetValue(item, null) + "'");
        //    //    sb.Append("\r\n");
        //    //}
        //    //sb.Append(" End ,\r\n");
        //    //sb.Append(" OpenId=case Id ");
        //    //foreach (var item in list)
        //    //{
        //    //    sb.Append(" when " + item.GetType().GetProperty("BuId").GetValue(item, null) + "" + " Then '" + item.GetType().GetProperty("OpenId").GetValue(item, null) + "'");
        //    //    sb.Append("\r\n");
        //    //}
        //    //sb.Append(" End ,\r\n");
        //    //sb.Append(" IsDistributed=case Id");
        //    //foreach (var item in list)
        //    //{
        //    //    sb.Append(" when " + item.GetType().GetProperty("BuId").GetValue(item, null) + "" + " Then '" + item.GetType().GetProperty("IsDistributed").GetValue(item, null) + "'");
        //    //    sb.Append("\r\n");
        //    //}
        //    //sb.Append(" End \r\n");
        ...
        //    return count;
        //}
        //public static object UpdateTimeAndStatusByList<T>(List<T> list, string connectionString, string tableName, List<long> ids) where T:class
        //{
        //    int count = 0;
        //    if (list == null || list.Count <= 0) throw new Exception("List无任何数据");
        //    if (string.IsNullOrEmpty(tableName)) throw new Exception("添加失败！请先设置插入的表名");
        //    var sql = PrepareSql<T>(list, "BatchRenewalId", tableName);
        //    #region 注释代码
        //    //StringBuilder sb = new StringBuilder();
        ...
        //    return count;
        //}
        //public static object UpdateByList<T>(List<T> list, string connectionString, string tableName, List<long> ids) where T : class
        //{
        //    int count = 0;
        //    if (list == null || list.Count <= 0) throw new Exception("List无任何数据");
        //    if (string.IsNullOrEmpty(tableName)) throw new Exception("添加失败！请先设置插入的表名");
