...
namespace BiHuManBu.ExternalInterfaces.Services.Implements.AppImplements
{
    public class AgentService : CommonBehaviorService, AppInterfaces.IAgentService
    {
        ...
        public AgentService(AppIRepository.IAgentRepository agentRepository, ICacheHelper cacheHelper,
            AppIRepository.IAgentConfigRepository agentConfigRepository, IHeBaoDianWeiRepository hebaoDianweiRepository, ISmsContentRepository smsContentRepository, ICityRepository cityRepository)
